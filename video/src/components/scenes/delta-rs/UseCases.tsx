...
const useCases = [
  {
    ...
    fields: ["no_cluster", "fast_iteration", "laptop_friendly"],
    color: COLORS.accent2,
  },
  {
    title: "CI/CD Pipelines",
    fields: ["schema_validation", "row_counts", "github_actions"],
    color: COLORS.accent1,
  },
  {
    title: "Microservices & APIs",
    fields: ["no_jvm_overhead", "fast_startup", "low_memory"],
