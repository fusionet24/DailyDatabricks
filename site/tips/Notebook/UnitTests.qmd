...
This tip was recently updated due to work going on with the databricks platform it seems the sys.module[__name__] call returns the different module details now. So the below code has been modified to resolve that by using the iPython Users Namespace.
:::
