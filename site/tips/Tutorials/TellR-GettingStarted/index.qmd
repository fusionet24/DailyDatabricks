...
![Permission request when first opening TellR](Assets/give permissions on app.png)
...
::: {.callout-tip title="Verify Your Genie Space" appearance="simple"}
You can test your Genie space directly in the Databricks UI by asking it questions like "What is the total revenue?" or "Show me the top 10 customers by purchase count." This helps confirm the data is accessible before using it in TellR.

![The underlying Genie space querying Bakehouse data](Assets/export in undelrying databricks genie space.png)
:::
...
![Step 3: Select the DailyDatabricks slide style](Assets/create profile style selector.png)
...
![Step 4: Select a deck prompt template](Assets/create profile deck prompt.png)
...
![Viewing the BakeHouse profile configuration](Assets/View Profile Information.png)
...
![TellR generating slides from Bakehouse data via Genie queries](Assets/generator of slides.png)
...
![The generated FY2025 Strategic Position Review presentation](Assets/first attemp .png)
...
<iframe src="Assets/fy2025-strategic-position-review.html" width="100%" height="600" style="border: 1px solid #ddd; border-radius: 8px;"></iframe>

You can also download the [PDF version](Assets/FY2025 Strategic Position Review_2026-01-31T23-01-49.pdf) of this presentation.
:::
